...
#elif defined(STRESS_ARCH_OR1K) && defined(STRESS_ARCH_LE)
	{ 8, 8, "l.jr r9; nop", { 0x00, 0x48, 0x00, 0x44, 0x00, 0x00, 0x00, 0x15 } };
#elif defined(STRESS_ARCH_OR1K) && defined(STRESS_ARCH_BE)
	{ 8, 8, "l.jr r9; nop", { 0x44, 0x00, 0x48, 0x00, 0x15, 0x00, 0x00, 0x00 } };
