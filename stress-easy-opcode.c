...
static const stress_easy_opcode_t easy_opcodes[] = {
	...
	{ 4, { 0x08, 0x09, 0x02, 0x49 } }, /* copy r9,r8 */
	{ 4, { 0x08, 0x0a, 0x02, 0x4a } }, /* copy r10,r10 */
	{ 4, { 0x08, 0x0b, 0x02, 0x4b } }, /* copy r11,r11 */
	{ 4, { 0x08, 0x0c, 0x02, 0x4c } }, /* copy r12,r12 */
	{ 4, { 0x08, 0x0d, 0x02, 0x4d } }, /* copy r13,r13 */
	{ 4, { 0x08, 0x0e, 0x02, 0x4e } }, /* copy r14,r14 */
	{ 4, { 0x08, 0x0f, 0x02, 0x4f } }, /* copy r15,r15 */
};
...
static const stress_easy_opcode_t easy_opcodes[] = {
	...
	{ 4, { 0x00, 0x15, 0x02, 0x31 } }, /* move $t5,$t5 */
	{ 4, { 0x00, 0x15, 0x02, 0x52 } }, /* move $t6,$t6 */
	{ 4, { 0x00, 0x15, 0x02, 0x73 } }, /* move $t7,$t7 */
};
...
static const stress_easy_opcode_t easy_opcodes[] = {
	...
	{ 2, { 0x22, 0x01 } }, /* movel %d1,%d1 */
	{ 2, { 0x24, 0x02 } }, /* movel %d2,%d2 */
	{ 2, { 0x26, 0x03 } }, /* movel %d3,%d3 */
	{ 2, { 0x28, 0x04 } }, /* movel %d4,%d4 */
	{ 2, { 0x2a, 0x05 } }, /* movel %d5,%d5 */
	{ 2, { 0x2c, 0x06 } }, /* movel %d6,%d6 */
	{ 2, { 0x2e, 0x07 } }, /* movel %d7,%d7 */
        { 2, { 0x50, 0xc0 } }, /* st %d0 */
        { 2, { 0x51, 0xc0 } }, /* sf %d0 */
        { 2, { 0x52, 0xc0 } }, /* shi %d0 */
        { 2, { 0x53, 0xc0 } }, /* sls %d0 */
...
#define HAVE_EASY_OPCODES
static const stress_easy_opcode_t easy_opcodes[] = {
	{ 4, { 0x00, 0x00, 0x00, 0x15 } }, /* nop */
	{ 4, { 0x04, 0xf8, 0xff, 0xe3 } }, /* l.or r31,r31,r31 */
	{ 4, { 0x04, 0xe8, 0xbd, 0xe3 } }, /* l.or r29,r29,r29 */
	{ 4, { 0x04, 0xd8, 0x7b, 0xe3 } }, /* l.or r27,r27,r27 */
	{ 4, { 0x04, 0xc8, 0x39, 0xe3 } }, /* l.or r25,r25,r25 */
	{ 4, { 0x04, 0xb8, 0xf7, 0xe2 } }, /* l.or r23,r23,r23 */
	{ 4, { 0x04, 0xa8, 0xb5, 0xe2 } }, /* l.or r21,r21,r21 */
	{ 4, { 0x04, 0x98, 0x63, 0xe2 } }, /* l.or r19,r19,r19 */
};
#elif defined(STRESS_ARCH_OR1K) &&	\
      defined(STRESS_ARCH_BE) &&	\
      defined(HAVE_MPROTECT)
#define HAVE_EASY_OPCODES
static const stress_easy_opcode_t easy_opcodes[] = {
	{ 4, { 0x15, 0x00, 0x00, 0x00 } }, /* nop */
	{ 4, { 0xe3, 0xff, 0xf8, 0x04 } }, /* l.or r31,r31,r31 */
	{ 4, { 0xe3, 0xbd, 0xe8, 0x04 } }, /* l.or r29,r29,r29 */
	{ 4, { 0xe3, 0x7b, 0xd8, 0x04 } }, /* l.or r27,r27,r27 */
	{ 4, { 0xe3, 0x39, 0xc8, 0x04 } }, /* l.or r25,r25,r25 */
	{ 4, { 0xe2, 0xf7, 0xb8, 0x04 } }, /* l.or r23,r23,r23 */
	{ 4, { 0xe2, 0xb5, 0xa8, 0x04 } }, /* l.or r21,r21,r21 */
	{ 4, { 0xe2, 0x73, 0x98, 0x04 } }, /* l.or r19,r19,r19 */
};
...
static const stress_easy_opcode_t easy_opcodes[] = {
	...
	{ 4, { 0x78, 0x1b, 0x63, 0x7c } }, /* mr %r3,%r3 */
	{ 4, { 0x78, 0x23, 0x84, 0x7c } }, /* mr %r4,%r4 */
	{ 4, { 0x78, 0x2b, 0xa5, 0x7c } }, /* mr %r5,%r5 */
	{ 4, { 0x78, 0x33, 0xc6, 0x7c } }, /* mr %r6,%r6 */
	{ 4, { 0x78, 0x3b, 0xe7, 0x7c } }, /* mr %r7,%r7 */
	{ 4, { 0x78, 0x43, 0x08, 0x7d } }, /* mr %r8,%r8 */
	{ 4, { 0x78, 0x4b, 0x29, 0x7d } }, /* mr %r9,%r9 */
	{ 4, { 0x78, 0x53, 0x4a, 0x7d } }, /* mr %r10,%r10 */
};
...
{
	uint8_t *ptr = (uint8_t *)ops_begin;
	uint8_t *ptr_end;
	size_t ops = 0;
	size_t i;
	size_t max_op_len = stress_ret_opcode.len;
...
static int stress_easy_opcode(stress_args_t *args)
{
	...
	stress_memory_anon_name_set(opcodes, page_size * PAGES, "opcodes");
