...
typedef void (*stress_matrix_3d_func_t)(
	const size_t n,
	const stress_matrix_3d_type_t a[RESTRICT n][n][n],
	const stress_matrix_3d_type_t b[RESTRICT n][n][n],
...
static void OPTIMIZE3 TARGET_CLONES stress_matrix_3d_xyz_trans(
	const size_t n,
	const stress_matrix_3d_type_t a[RESTRICT n][n][n],
	const stress_matrix_3d_type_t b[RESTRICT n][n][n],	/* Ignored */
	stress_matrix_3d_type_t r[RESTRICT n][n][n])
{
	register size_t i;
...
{
	register size_t k;
	const stress_matrix_3d_type_t v = b[0][0][0];
...
static int stress_matrix_3d(stress_args_t *args)
{
	...
	if (stress_instance_zero(args))
		stress_memory_usage_get(args, 3 * matrix_3d_mmap_size, 3 * matrix_3d_mmap_size * args->instances);
...
static const stress_opt_t opts[] = {
	{ OPT_matrix_3d_method,	"matrix-3d-method", TYPE_ID_SIZE_T_METHOD, 0, 0, (void *)stress_matrix_3d_method },
...
static const stress_opt_t opts[] = {
	{ OPT_matrix_3d_method,	"matrix-3d-method", TYPE_ID_SIZE_T_METHOD, 0, 0, (void *)stress_unimplemented_method},
	{ OPT_matrix_3d_size,   "matrix-3d-size",   TYPE_ID_SIZE_T, MIN_MATRIX3D_SIZE, MAX_MATRIX3D_SIZE, NULL },
	{ OPT_matrix_3d_zyx,    "matrix-3d-zyx",    TYPE_ID_BOOL, 0, 1, NULL },
	END_OPT,
};
