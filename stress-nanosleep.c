...
static int stress_nanosleep(stress_args_t *args)
{
	...
	if (!stress_setting_get("nanosleep-threads", &nanosleep_threads)) {
	...
	(void)stress_setting_get("nanosleep-method", &nanosleep_method);
...
tidy:
	...
	stress_metrics_set(args, "nanosec sleep overrun",
	...
	stress_metrics_set(args, "nanosec sleep underrun",
