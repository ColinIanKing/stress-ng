...
static const stress_t stressors[] = {
	...
	STRESSOR(remap, REMAP_FILE_PAGES),
	...
	STRESSOR(seek, SEEK),
	STRESSOR(sem, SEMAPHORE_POSIX),
	STRESSOR(sem_sysv, SEMAPHORE_SYSV),
	STRESSOR(sendfile, SENDFILE),
	STRESSOR(set, SET),
	STRESSOR(shm, SHM_POSIX),
	...
	STRESSOR(sock, SOCKET),
	STRESSOR(sockdiag, SOCKET_DIAG),
	STRESSOR(sockfd, SOCKET_FD),
	STRESSOR(sockpair, SOCKET_PAIR),
