...
static const stress_t stressors[] = {
	...
	STRESSOR(dynlib, DYNLIB, CLASS_OS),
	STRESSOR(efivar, EFIVAR, CLASS_OS),
	STRESSOR(enosys, ENOSYS, CLASS_OS),
	...
	STRESSOR(file_ioctl, FILE_IOCTL, CLASS_FILESYSTEM | CLASS_OS),
	...
	STRESSOR(mcontend, MCONTEND, CLASS_MEMORY),
	...
	STRESSOR(mmapfixed, MMAPFIXED, CLASS_VM | CLASS_OS),
	...
	STRESSOR(sigpipe, SIGPIPE, CLASS_INTERRUPT | CLASS_OS),
	...
	STRESSOR(sysbadaddr, SYSBADADDR, CLASS_OS),
	...
	STRESSOR(vm_segv, VM_SEGV, CLASS_VM | CLASS_MEMORY | CLASS_OS),
