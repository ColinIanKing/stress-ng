...
enum {
	...
	STRESS_PERF_HW_CACHE_OP_READ,
	STRESS_PERF_HW_CACHE_OP_WRITE,
	STRESS_PERF_HW_CACHE_OP_PREFETCH,
	STRESS_PERF_HW_CACHE_L1D,
	STRESS_PERF_HW_CACHE_L1I,
	STRESS_PERF_HW_CACHE_LL,
	STRESS_PERF_HW_CACHE_DTLB,
	STRESS_PERF_HW_CACHE_ITLB,
	...
	STRESS_PERF_TP_SCHED_PROC_EXEC,
	STRESS_PERF_TP_SCHED_PROC_EXIT,
	STRESS_PERF_TP_SCHED_PROC_FORK,
	STRESS_PERF_TP_SCHED_PROC_FREE,
	STRESS_PERF_TP_SCHED_PROC_HANG,
	STRESS_PERF_TP_SCHED_PROC_WAIT,
	STRESS_PERF_TP_SCHED_SWITCH,
	...
	STRESS_PERF_TP_MIGRATE_MM_PAGES,
	STRESS_PERF_TP_SKB_CONSUME,
	STRESS_PERF_TP_SKB_KFREE,
	STRESS_PERF_TP_IOMMU_IO_PAGE_FAULT,
	STRESS_PERF_TP_IOMMU_MAP,
	STRESS_PERF_TP_IOMMU_UNMAP,
	STRESS_PERF_MAX
};
...
extern void stress_set_timer_slack_ns(const char *opt);
...
extern void stress_set_malloc_bytes(const char *opt);
...
extern void stress_set_shm_sysv_segments(const char *opt);
extern void stress_set_sleep_max(const char *opt);
...
extern void stress_set_socket_port(const char *opt);
extern void stress_set_socket_fd_port(const char *opt);
...
extern void stress_set_userfaultfd_bytes(const char *opt);
extern void stress_set_vfork_max(const char *opt);
