...
static int shim_pkey_alloc(unsigned long flags, unsigned long access_rights)
{
...
static int shim_pkey_free(int pkey)
{
...
static int shim_pkey_mprotect(void *addr, size_t len, int prot, int pkey)
{
...
static int shim_pkey_get(int pkey)
{
...
static int shim_pkey_set(int pkey, unsigned int rights)
{
