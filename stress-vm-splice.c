...
static int stress_vm_splice(stress_args_t *args)
{
	...
	stress_memory_anon_name_set((void *)buf, sz, "iov-buffer");
	...
	stress_memory_anon_name_set((void *)data, page_size, "io-buffer");
